...
#
# Notes
# Modified by Andrea Chiang for option to display isotropic part, last update on May 22, 2018
# -----------------------------------------------
"""
...
def beach(fm, linewidth=2, facecolor='b', bgcolor='w', edgecolor='k',
          ...
          zorder=100, mopad_basis='USE', axes=None, show_iso=False):
    """
    ...
    mt = mopad_MomentTensor(fm, in_system=mopad_basis)
